...
if __name__ == '__main__':
    ...
    df_data = pd.read_csv("./extra_data.csv")
    img_path_list = df_data['path'].values.tolist()
    label_list = df_data['gender'].values.tolist()
    ...
    res[ ['filepath', 'target', 'fold'] ].to_csv("./data/extra_gender_train.csv", index=False) 
...
if __name__ == '__main__':
    ...
    df_data = pd.read_csv("./extra_data.csv")
    img_path_list = df_data['path'].values.tolist()
    label_list = df_data['mask'].values.tolist()
    ...
    res['target'] = data_label[:,1]
    res['fold'] = data_label[:,2]
    res[ ['filepath', 'target', 'fold'] ].to_csv("./data/extra_mask_train.csv", index=False) 
...
if __name__ == '__main__':
    ...
    df_data = pd.read_csv("./extra_data.csv")
    img_path_list = df_data['path'].values.tolist()
    label_list = df_data['age'].values.tolist()
    ...
    res['target'] = data_label[:,1]
    res['fold'] = data_label[:,2]
    res[ ['filepath', 'target', 'fold'] ].to_csv("./data/extra_age_train.csv", index=False) 